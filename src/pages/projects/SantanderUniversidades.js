...
SantanderUniversidades.defaultProps = {
    en: {
        ...
        about: [
            {
                type: 'text',
                data: 'In august of 2017 I was invited to develop the new “Santander Universidades” site. This project was on a critical state and we can say that also, this was an urgent project. This because the people in charge quit and took off all the code that he had.',
            },
            {
                type: 'text',
    ...
    es: {
        ...
        about: [
            {
                type: 'text',
                data: 'En agosto de 2017 fui invitado a desarrollar el nuevo sitio de Santander Universidades. Este proyecto, estaba en un estado crítico, y podemos decir que de urgencia, pues la persona que se estaba encargando de llevarlo a cabo, renunció y no dejó nada de su código.'
            },
            {
                type: 'text',
